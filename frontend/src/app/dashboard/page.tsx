                    ...
                    <div className="flex gap-3 items-center">
                      ...
                      {!msg.isRead && (
                        <button 
                          ...
                          className="inline-flex items-center gap-2 px-4 py-2 bg-brand-gold/10 text-brand-gold text-xs font-bold uppercase tracking-widest rounded-lg hover:bg-brand-gold/20 transition-colors"
                        >
