...
export default function PlayerLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://horizon-backend-production-4f7a.up.railway.app"}/api/auth/unified/login`, {
        method: "POST",
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://horizon-backend-production-4f7a.up.railway.app"}/api/auth/forgot-password`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
